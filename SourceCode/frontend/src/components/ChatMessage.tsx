    ...
    return (
      <div className="flex gap-2.5 max-w-[88%] animate-[msgIn_0.3s_cubic-bezier(0.4,0,0.2,1)]">
        ...
        <div className="flex-1 min-w-0">
          {/* Bubble text */}
          {message.content && (
            <div className="bg-white px-4 py-3 rounded-2xl rounded-tl-sm border border-slate-200 text-base leading-relaxed text-slate-900 shadow-sm mb-2">
              {message.content}
            </div>
          )}
        ...
        <div className="flex-1 w-full">
          <div className="bg-[#0f172a] rounded-lg overflow-hidden">
            <div className="flex items-center justify-between px-3.5 py-2 border-b border-white/[0.06] bg-white/[0.02]">
              <span className="text-xs font-medium text-slate-400 font-mono">脚本预览</span>
            </div>
  ...
  if (message.type === 'error') {
    return (
      <div className={`flex gap-2.5 max-w-[88%] animate-[msgIn_0.3s_cubic-bezier(0.4,0,0.2,1)] ${isUser ? 'self-end flex-row-reverse' : ''}`}>
        ...
        <div className={`rounded-xl px-4 py-3 text-base leading-relaxed shadow-sm ${
          isUser
