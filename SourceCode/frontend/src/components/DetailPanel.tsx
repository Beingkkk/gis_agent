...
export default function DetailPanel({
  ...
  // ─── ERROR_RECOVERY → read-only ParamForm to keep params visible ───────
  if (state === 'ERROR_RECOVERY' && errorContext && templateDetail) {
    return (
      <div className="flex flex-col h-full">
        {/* Error Banner */}
        <div
  ...
  // ─── ERROR_RECOVERY without template detail → minimal banner ────────────
